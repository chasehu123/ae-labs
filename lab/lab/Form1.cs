...
namespace lab
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
            ...
            ///////////////// cleartool_init/////////////////
        {
            axToolbarControl1.AddItem(new cleartool(), -1, -1, false, 0, esriCommandStyles.esriCommandStyleIconOnly);
            ...
            //////////////////////// lab10_init /////////////////////////
            ICommand addData = new AddDateTool(axToolbarControl1,axPageLayoutControl1); axToolbarControl1.AddItem(addData, -1, -1, false, 0,esriCommandStyles.esriCommandStyleIconAndText);
        }
    }
}
